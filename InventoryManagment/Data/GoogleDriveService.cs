...
{
    readonly string _windowsClientId = "876341543585-e8osvdlssnfn7gpu73staeoblphhb4jo.apps.googleusercontent.com";      // UWP client
    ...
    public async Task<string> UploadFile(string filePath, string? mimeType = null, string? parentFolderId = null)
    {
        if (_driveService == null)
            throw new InvalidOperationException("Drive service not initialized. Please sign in first.");
